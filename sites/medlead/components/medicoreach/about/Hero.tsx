...
const Hero: React.FC = () => {
  return (
    <section className="relative bg-surface-light dark:bg-surface-dark overflow-hidden py-20 lg:py-28">
      <div className="absolute inset-0 opacity-40 dark:opacity-10" style={{ backgroundImage: 'radial-gradient(#008080 0.5px, transparent 0.5px)', backgroundSize: '24px 24px' }}></div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <button className="bg-primary hover:bg-teal-700 text-white text-lg px-8 py-3.5 rounded-full font-bold shadow-lg hover:shadow-xl transition transform hover:-translate-y-1">Meet The Team</button>
              <button className="bg-white hover:bg-gray-50 dark:bg-slate-800 dark:hover:bg-slate-700 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-600 text-lg px-8 py-3.5 rounded-full font-bold transition">Our Process</button>
            </div>
          </div>
          <div className="relative lg:block">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-8 border-white dark:border-slate-800 transform rotate-2 hover:rotate-0 transition duration-500">
              <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuCvyausbq2mi4raWyO8CDFdh6uAx5GRVDA8iKiwSwABvesTsmrEihSPzPSdTU-t8xkrMvWWmyXrKrIbnxwwlPH274u-ZtRVqtZCJI6SdrqUAfEdLO25f5fehPVQloHOUR2sKbuKZMu-9SIhxZc0IoFqwdirN-G3mQkJb2Zg7iD0Ny4Cz-Z2FCtZo75I2PGyWWgnXAzs87pNBb-crajF3IpcO9CCXIRGgKjsK7Eb-V9XgCwRzsMjJWz6NWKQWOYDZtiWzkIqqHR-kzs" alt="Collaborative Medical Team" className="w-full h-auto object-cover scale-105" />
