    ...
    <section className="py-24 bg-white dark:bg-background-dark relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">From a small data startup to a global healthcare intelligence partner, our path has been defined by a relentless pursuit of accuracy.</p>
        </div>
