  ...
  const studies = [
    {
      ...
      title: "How Medlead Boosts Leading Psychiatric Care Referrals"
    },
    {
      ...
      title: "How Medlead Helped a Renowned University Increase Lead Gen"
    },
    {
      ...
      title: "Medlead Helped a Premier CME Provider Improve Outreach"
    }
  ];
      ...
      <section className="bg-gradient-to-r from-teal-500 to-cyan-500 dark:from-teal-900 dark:to-cyan-900 py-12 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white">
            <h3 className="text-2xl font-bold text-white">Ready to boost your medical sales?</h3>
