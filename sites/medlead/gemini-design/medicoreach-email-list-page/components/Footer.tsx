        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4 text-gray-400">
              <a href="#" className="hover:text-secondary transition"><span className="material-symbols-outlined text-lg">social_leaderboard</span></a>
              <a href="#" className="hover:text-secondary transition">X</a>
              <a href="#" className="hover:text-secondary transition"><span className="material-symbols-outlined text-lg">ondemand_video</span></a>
              <a href="#" className="hover:text-secondary transition">in</a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="#" className="hover:text-secondary transition">Data Reseller Partnership</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li><a href="#" className="hover:text-secondary transition">Healthcare Databases</a></li>
              <li><a href="#" className="hover:text-secondary transition">Case Studies</a></li>
              <li><a href="#" className="hover:text-secondary transition">Glossary</a></li>
              <li><a href="#" className="hover:text-secondary transition">FAQ</a></li>
              <li><a href="#" className="hover:text-secondary transition">Code Lookup Tools</a></li>
            </ul>
          </div>
