        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
              You could be looking for ways to improve your email marketing campaigns, or you are new to email marketing; irrespective of the scenario, you could put the company's resources to better use by leaving email campaigns to MedicoReach.
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
              Let MedicoReach do the heavy-lifting job of running professional and personalized email campaigns.
            </p>
          ...
          <div className="relative flex justify-center">
            {/* Rotating Ring */}
            <div className="relative w-80 h-80 rounded-full bg-surface-light dark:bg-surface-dark border-4 border-dashed border-primary flex items-center justify-center animate-spin-slow">
              {/* This inner div is just to maintain structure if needed, but the border is on parent */}
            </div>
