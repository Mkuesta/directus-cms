          ...
          <div>
            ...
            <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
              <div>
                ...
                <input type="text" className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded focus:outline-none focus:border-secondary text-sm" placeholder="Name" />
              </div>
              <div>
                <label className="sr-only">Email address</label>
                <input type="email" className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded focus:outline-none focus:border-secondary text-sm" placeholder="Email address" />
              </div>
